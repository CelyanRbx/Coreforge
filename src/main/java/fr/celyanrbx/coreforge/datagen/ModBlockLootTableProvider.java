...
public class ModBlockLootTableProvider extends BlockLootSubProvider {
    ...
    protected void generate() {
        ...
        add(ModBlocks.DEEPSLATE_STEEL_ORE.get(),
                block -> createMultipleOreDrops(ModBlocks.DEEPSLATE_STEEL_ORE.get(), ModItems.STEEL.get(), 2, 5));
        add(ModBlocks.END_STEEL_ORE.get(),
                block -> createMultipleOreDrops(ModBlocks.END_STEEL_ORE.get(), ModItems.STEEL.get(), 2, 5));
        add(ModBlocks.NETHER_STEEL_ORE.get(),
                block -> createMultipleOreDrops(ModBlocks.NETHER_STEEL_ORE.get(), ModItems.STEEL.get(), 2, 5));
